...
var studentInfoForAllStudents = KeysDemoDbContext.VCitiesInCountries.ToArray();
foreach (var info in studentInfoForAllStudents)
{
    Console.WriteLine($"Country:{info.CountryName}, Pop:{info.CountryPopulation}, City:{info.CityName}, Pop:{info.CityPopulation}");
}